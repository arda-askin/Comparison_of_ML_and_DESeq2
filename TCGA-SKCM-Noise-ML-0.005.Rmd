...
```{r}
tr_data <- noise_adder(train, 0.005)
te_data <- noise_adder(test, 0.005)
...
search_criteria <- list(strategy = "RandomDiscrete", 
 ...
 dl_grid_0.005 <- h2o.grid(algorithm = "deeplearning", 
                    x = x,
                    y = y,
                    # weights_column = weights,
                    grid_id = "dl_grid_0.005",
  ...
  gridperf_0.005 <- h2o.getGrid(grid_id = "dl_grid_0.005",
                             sort_by = "auc",
                             decreasing = TRUE)
  ...
  best_ann <- h2o.getModel(gridperf_0.005@model_ids[[1]])
  
  h2o.saveModel(best_ann,"noise_ifn_ann_0.005.rds")
