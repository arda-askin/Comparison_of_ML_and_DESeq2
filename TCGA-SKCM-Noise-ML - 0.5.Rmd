...
```{r}
tr_data <- noise_adder(train, 0.5)
te_data <- noise_adder(test, 0.5)
...
search_criteria <- list(strategy = "RandomDiscrete", 
 ...
 dl_grid_0.5 <- h2o.grid(algorithm = "deeplearning", 
                    x = x,
                    y = y,
  ...
  gridperf_0.5 <- h2o.getGrid(grid_id = "dl_grid_0.5",
                             sort_by = "auc",
                             decreasing = TRUE)
  ...
  best_ann <- h2o.getModel(gridperf_0.5@model_ids[[1]])
  
  h2o.saveModel(best_ann,"noise_ifn_ann_0.05.rds")
  
#"C:\\TCGA_SKCM_model\\noise_ifn_ann_0.05.rds\\dl_grid_0.5_model_4"
