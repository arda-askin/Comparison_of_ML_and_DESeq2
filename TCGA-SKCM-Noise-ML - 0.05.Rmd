...
```{r}
tr_data <- noise_adder(train, 0.05)
te_data <- noise_adder(test, 0.05)
...
search_criteria <- list(strategy = "RandomDiscrete", 
 ...
 dl_grid_0.05 <- h2o.grid(algorithm = "deeplearning", 
                    x = x,
                    y = y,
                    # weights_column = weights,
                    grid_id = "dl_grid_0.05",
  ...
  gridperf_0.05 <- h2o.getGrid(grid_id = "dl_grid_0.05",
                             sort_by = "auc",
                             decreasing = TRUE)
  ...
  best_ann <- h2o.getModel(gridperf_0.05@model_ids[[1]])
